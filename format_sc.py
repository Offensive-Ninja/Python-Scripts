...
# thanks to: https://www.redteam.cafe/red-team/shellcode-injection/shellcode-formatter
# edited slightly to take args lol

with open(sys.argv[1], 'rb') as sc_handle:
...
with open('formatted__shellcode.txt', 'w') as format_out:
